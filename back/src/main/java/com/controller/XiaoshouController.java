    ...
    */
    ...
    public R save(@RequestBody XiaoshouEntity xiaoshou, HttpServletRequest request){
        ...
        Wrapper<XiaoshouEntity> queryWrapper = new EntityWrapper<XiaoshouEntity>()
            ...
            .eq("xiaoshou_name", xiaoshou.getXiaoshouName())
            .eq("xiaoshou_number", xiaoshou.getXiaoshouNumber())
            .eq("xiaoshou_types", xiaoshou.getXiaoshouTypes())
            ;
...
//                            xiaoshouEntity.setXiaoshouUuidNumber(data.get(0));                    //唯一编号 要改的
//                            xiaoshouEntity.setYuangongId(Integer.valueOf(data.get(0)));   //员工 要改的
//                            xiaoshouEntity.setXiaoshouName(data.get(0));                    //销售名称 要改的
//                            xiaoshouEntity.setXiaoshouNumber(Integer.valueOf(data.get(0)));   //销售数量 要改的
//                            xiaoshouEntity.setXiaoshouTypes(Integer.valueOf(data.get(0)));   //销售类型 要改的
//                            xiaoshouEntity.setXiaoshouTime(sdf.parse(data.get(0)));          //销售时间 要改的
//                            xiaoshouEntity.setXiaoshouJine(data.get(0));                    //销售金额 要改的
//                            xiaoshouEntity.setXiaoshouContent("");//详情和图片
