...
public class XiaoshouView extends XiaoshouEntity implements Serializable {
	...
	public XiaoshouView(XiaoshouEntity xiaoshouEntity) {
		try {
			...
			* 获取： 销售类型的值
			*/
			public String getXiaoshouValue() {
				return xiaoshouValue;
			}
			/**
			* 设置： 销售类型的值
			*/
			public void setXiaoshouValue(String xiaoshouValue) {
				this.xiaoshouValue = xiaoshouValue;
			}
				...
				//级联表的get和set yuangong
					...
					* 获取： 户籍
					*/
					public String getYuangongHuji() {
						return yuangongHuji;
					}
					/**
					* 设置： 户籍
					*/
					public void setYuangongHuji(String yuangongHuji) {
						this.yuangongHuji = yuangongHuji;
					}
