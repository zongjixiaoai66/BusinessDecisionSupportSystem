    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="唯一编号" prop="xiaoshouUuidNumber">
                       <el-input v-model="ruleForm.xiaoshouUuidNumber"
                                 placeholder="唯一编号" clearable  :readonly="ro.xiaoshouUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="唯一编号" prop="xiaoshouUuidNumber">
                           <el-input v-model="ruleForm.xiaoshouUuidNumber"
                                     placeholder="唯一编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
            <input id="yuangongId" name="yuangongId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="销售名称" prop="xiaoshouName">
                       <el-input v-model="ruleForm.xiaoshouName"
                                 placeholder="销售名称" clearable  :readonly="ro.xiaoshouName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="销售名称" prop="xiaoshouName">
                           <el-input v-model="ruleForm.xiaoshouName"
                                     placeholder="销售名称" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="销售数量" prop="xiaoshouNumber">
                       <el-input v-model="ruleForm.xiaoshouNumber"
                                 placeholder="销售数量" clearable  :readonly="ro.xiaoshouNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="销售数量" prop="xiaoshouNumber">
                           <el-input v-model="ruleForm.xiaoshouNumber"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="销售类型" prop="xiaoshouTypes">
                        <el-select v-model="ruleForm.xiaoshouTypes" :disabled="ro.xiaoshouTypes" placeholder="请选择销售类型">
                            <el-option
                                v-for="(item,index) in xiaoshouTypesOptions"
                    ...
                    <div v-else>
                        <el-form-item class="input" label="销售类型" prop="xiaoshouValue">
                        <el-input v-model="ruleForm.xiaoshouValue"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="销售金额" prop="xiaoshouJine">
                       <el-input v-model="ruleForm.xiaoshouJine"
                                 placeholder="销售金额" clearable  :readonly="ro.xiaoshouJine"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="销售金额" prop="xiaoshouJine">
                           <el-input v-model="ruleForm.xiaoshouJine"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="销售备注" prop="xiaoshouContent">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.xiaoshouContent" label="销售备注" prop="xiaoshouContent">
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ...
                   xiaoshouName: [
                              { required: true, message: '销售名称不能为空', trigger: 'blur' },
                          ],
                   xiaoshouNumber: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=xiaoshou_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.xiaoshouTypesOptions = data.data.list;
                    }
                });
