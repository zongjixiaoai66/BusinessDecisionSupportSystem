    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="现住址" prop="yuangongAddress">
                       <el-input v-model="ruleForm.yuangongAddress"
                                 placeholder="现住址" clearable  :readonly="ro.yuangongAddress"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="现住址" prop="yuangongAddress">
                           <el-input v-model="ruleForm.yuangongAddress"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="户籍" prop="yuangongHuji">
                       <el-input v-model="ruleForm.yuangongHuji"
                                 placeholder="户籍" clearable  :readonly="ro.yuangongHuji"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="户籍" prop="yuangongHuji">
                           <el-input v-model="ruleForm.yuangongHuji"
                                     placeholder="户籍" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
            </el-row>
