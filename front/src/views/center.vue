  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='yuangong'"  label='现住址' prop="yuangongAddress">
               <el-input v-model="ruleForm.yuangongAddress"  placeholder='现住址' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='yuangong'"  label='户籍' prop="yuangongHuji">
               <el-input v-model="ruleForm.yuangongHuji"  placeholder='户籍' clearable></el-input>
           </el-form-item>
         </el-col>
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.yuangongHuji)&& 'yuangong'==this.flag){
                             this.$message.error('户籍不能为空');
                             return
                         }
